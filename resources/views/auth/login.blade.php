...
@section('content')
    <div class="login center">
        ...
        <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
            ...
            <input type="text" class="input txt-center w-100" v-model="name" placeholder="会員番号" id="username" name="username"/>
            <input type="password" class="input txt-center w-100" v-model="name" placeholder="パスワード" id="password" name="password"/>
